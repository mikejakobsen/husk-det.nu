...
| ACK [search_pattern] [file] | Search for all lines that contain the pattern, e.g. `ACK "Tom" file.txt` |
| ACK -r [search_pattern] [file] | Recursively search for all lines that do not contain the pattern |
| ACK -v [search_pattern] [file] | Search for all lines that do NOT contain the pattern |
