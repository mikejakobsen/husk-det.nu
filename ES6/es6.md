...
The map function is being called on the arr array - return each fruit, then appening an s to the end.
...
The Arrow function specification draft
...
// }
```
The `depreciate` function is then called with. `car.depreciate();`
